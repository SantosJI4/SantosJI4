...
### 🚀 Sobre Mim
- 🎓 Estudante de **Desenvolvimento de Software** (2025/2026).
- 🛠️ Experiência profissional em **Segurança da Informação**.
- 🎮 Game Developer independente utilizando **GDevelop**.
- 📊 Especialista em automação e análise de dados.
...
* **Futamigo:** Aplicação focada em gestão e classificação de futebol.
* **Scripts de Automação:** Desenvolvimento de ferramentas para otimização de fluxos de trabalho e cibersegurança.
* **Game Dev:** Projetos autorais criados na GDevelop com foco em mecânicas 2D e Pixel Art.
...
[![YouTube](https://img.shields.io/badge/YouTube-%23FF0000.svg?style=for-the-badge&logo=YouTube&logoColor=white)](LINK_DO_TEU_CANAL)

---

*"A vereda dos justos é como a luz da alvorada, que brilha cada vez mais até à plena luz do dia." (Provérbios 4:18)*
